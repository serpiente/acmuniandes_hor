...
function consultarCursosPorNombreProfesor($profesor, $cbuflag) {
	//TODO
	global $dao;
	//Permite utilizar esta variable declarada fuera de la funcion

	try {

		$array = $dao -> consultarCursosPorNombreProfesor($profesor, $cbuflag);
		echo $array;
	} catch(Exception $e) {
		echo $e -> getMessage();
	}
...
function consultarCursosPorNombreCurso($curso, $cbuflag) {
	...
	try {
		$array = $dao -> consultarCursosPorNombreCurso($curso, $cbuflag);
		echo $array;
	} catch(Exception $e) {
	...
	function consultarCursosPorNombreDepartamento($depto, $cbuflag) {
		...
		try {
			$array = $dao -> consultarCursosPorNombreDepartamento($depto, $cbuflag);
			echo $array;
		} catch(Exception $e) {
			echo $e -> getMessage();
		}
	...
	function consultarCursosPorCBU($tipo) {
		...
		try {
			echo $array = $dao -> consultarCursosPorCBU($tipo);
		} catch(Exception $e) {
			echo $e -> getMessage();
		}
